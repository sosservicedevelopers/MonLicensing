...
using MonLicensing.Areas.Identity;
using MonLicensing.Data;
using MonLicensing.Models;
using MonLicensing.Services;

namespace MonLicensing
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IServiceProvider serviceProvider, ApplicationDbContext db)
        {
        ...
        private async Task CreateRoles(IServiceProvider serviceProvider, ApplicationDbContext db)
        {
            ...
            string[] roleNames = { "Admin", "Manager", "Users" };
